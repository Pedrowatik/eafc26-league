...
function SofifaImport({ importPlayerDatabase }) {
  ...
  const [rawSample, setRawSample] = useState(null); // temporary debug: checking specifically for an image field
      ...
      {rawSample && (
        <div style={{ marginTop: 14, background: C.panelAlt, borderRadius: 8, padding: 12 }}>
          <div style={{ color: C.gold, fontWeight: 700, fontSize: 12, marginBottom: 6 }}>
            Debug: raw data for the first player (temporary — checking for an image/photo field, copy this to Claude)
          </div>
